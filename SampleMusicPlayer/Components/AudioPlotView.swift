...
//        }
     ...
     */
    func updateBuffer(buffer: [Float], bufferSize size: UInt32) {
        setSampleData(buffer, length: Int(size)) //Becareful when cast type
    }
    
    func setSampleData(data: [Float], length: Int) {
